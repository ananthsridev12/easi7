...
tagline: 'CPL measures the cost of a lead; CAC measures the fully-loaded cost of acquiring a paying customer. Optimising for the wrong one hides real performance.'
service_url: /services/search-engine-marketing
taxonomy:
    topic: [Strategy]
metadata:
    description: 'The difference between Cost Per Lead (CPL) and Customer Acquisition Cost (CAC), and why both matter.'
sitemap:
    changefreq: yearly
    priority: !!float 0.4
---

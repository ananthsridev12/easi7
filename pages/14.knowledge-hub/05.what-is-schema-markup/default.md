...
tagline: 'Schema markup is structured data added to a page''s code that explicitly tells search engines what the content means.'
service_url: /services/seo/technical-seo
taxonomy:
    topic: [SEO]
metadata:
    description: 'A plain-language explanation of schema markup and structured data, and why it helps search visibility.'
sitemap:
    changefreq: yearly
    priority: !!float 0.4
---

...
tagline: 'ROAS (Return On Ad Spend) measures revenue generated per unit of ad spend - useful, but incomplete without margin attached.'
service_url: /services/search-engine-marketing
taxonomy:
    topic: [Strategy]
metadata:
    description: 'A plain-language explanation of ROAS (Return On Ad Spend) and its limits as a standalone metric.'
sitemap:
    changefreq: yearly
    priority: !!float 0.4
---

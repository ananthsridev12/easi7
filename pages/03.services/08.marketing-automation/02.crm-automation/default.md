...
process:
    ...
    - { title: 'Hygiene', body: "Deduplication and required-field rules are built before automation goes live, so triggers aren't acting on bad data." }

...
metadata:
    description: 'Web application development services: custom web apps, customer portals, business portals, and internal tools.'
content:
    items: '@self.children'
    order:
        by: default
...
cta:
    heading: 'Need an app, not just a site?'
    body: "We size the build to the actual use case - a calculator, a portal, a dashboard - not enterprise software you don't need."
...
faqs:
    - q: 'How is this different from full enterprise software development?'
      a: "Scope - this is sized for marketing and operational use cases like a lead-capture calculator, a client portal, or an internal dashboard, not large-scale engineering builds. We'll say so directly if a project needs more than that."
    - q: 'Can a web app integrate with our existing CRM and analytics?'

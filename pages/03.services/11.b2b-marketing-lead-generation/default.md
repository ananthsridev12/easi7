...
tagline: 'B2B-specific demand generation and lead gen built around how enterprise buying committees actually decide.'
tools: [ABM, 'Demand Gen', 'Lead Scoring']
taxonomy:
    service: ['B2B Marketing & Lead Generation']
metadata:
    description: 'B2B marketing and lead generation services: ABM, demand generation, LinkedIn lead gen, lead nurturing, and sales enablement.'
content:
    items: '@self.children'
    order:
        by: default
...
cta:
    heading: 'Sales says the leads are the wrong ones?'
...
From there, the channel mix matters less than the discipline behind it - ABM for a short list of named targets, demand generation for building category awareness, and LinkedIn tactics where your buyers actually spend time. Every lead gets scored before it reaches sales, unready leads go into a nurture sequence instead of getting written off, and sales enablement content (battle cards, case studies) closes the loop for the team in the room when the deal gets decided.

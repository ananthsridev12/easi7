...
A rough 60/30/10 split across cold, warm, and hot audiences keeps the funnel fed without starving the stages that are closest to revenue. We adjust this ratio monthly based on what the data shows, not a fixed rule.

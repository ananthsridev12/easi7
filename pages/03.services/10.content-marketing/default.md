...
metadata:
    description: 'Content marketing services: strategy, blog and article writing, lead magnets, whitepapers, thought leadership, and distribution.'
content:
    items: '@self.children'
    order:
        by: default
...
cta:
    heading: 'Publishing content with nothing to show for it?'
    body: "We'll map what you have against real search demand before writing another word."
...
faqs:
    - q: 'How many articles do we need to publish per month?'
      a: "There's no universal number - a consistent one or two well-researched, keyword-mapped pieces a month outperforms ten generic ones. We plan volume around the keyword map, not a fixed publishing quota."
    - q: 'Do you write the content or just plan the strategy?'

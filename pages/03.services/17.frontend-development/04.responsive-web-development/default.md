...
summary: 'Responsive web development ensuring a consistent, fast experience across every device size.'
tools: ['Responsive Design', 'Mobile-first']
...
* Responsive image and asset optimisation

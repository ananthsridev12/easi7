...
tagline: 'Seven email automation workflows that convert, from welcome sequences to win-back campaigns.'
taxonomy:
    category: [Automation]
...
<p>Ultimately, the goal of email automation is not to send more emails - it's to send the right email at the right moment to the right segment. Every workflow should be designed backwards from that principle.</p>

...
tagline: 'Developed a data-driven content strategy resulting in 5x organic traffic growth over six months.'
metrics:
...
metadata:
    description: 'Data-driven content strategy that grew organic traffic 5x in six months for a B2B SaaS client.'
sitemap:
    changefreq: yearly
    priority: !!float 0.5
---

...
methodology:
    ...
    - { title: Build, body: 'Guardrails and escalation paths designed in from the start, not added after an incident.' }
    - { title: Monitor, body: 'Accuracy and outcomes tracked after launch, with a human still in the loop where it matters.' }
categories:
...
faqs:
    - q: "How do you make sure an AI agent or chatbot doesn't give wrong answers?"
      a: "By grounding responses in your actual documentation rather than general model knowledge, and building clear escalation to a human whenever confidence is low - not by promising it never happens."
    - q: 'Is this going to replace our team?'
...
cta:
    heading: "Considering AI for a specific problem?"
    body: "We'll help you scope it narrow enough to actually trust in production."
